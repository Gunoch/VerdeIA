...
import { AlertCircle, BarChart3, Droplets, Recycle, Trash2, Trees } from "lucide-react";
import Image from "next/image";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Estatísticas Nacionais - VerdeAI",
  description: "Dados e estatísticas ambientais importantes sobre o Brasil.",
};
...
interface StatData {
  ...
  imageHint: string;
  description?: string;
  trend?: "positive" | "negative" | "neutral"; // Para indicar visualmente uma tendência
}
...
const nationalStats: StatData[] = [
  ...
  },
  {
    ...
    trend: "positive", // Mesmo baixo, qualquer aumento é positivo
  },
  {
    id: "desmatamento",
    ...
    value: "11.568",
    unit: "km²/ano",
    year: "2022", // Dados geralmente consolidados no ano seguinte
    source: "PRODES/INPE",
    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
        {nationalStats.map((stat) => (
          <Card key={stat.id} className="overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col">
      ...
      <Card className="mt-8 bg-card border-border shadow-md">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            As estatísticas apresentadas nesta página são coletadas de fontes oficiais e relatórios públicos, refletindo os dados mais recentes disponíveis no momento da sua inclusão. Estes números não são atualizados em tempo real. O objetivo é fornecer um panorama educativo e de conscientização sobre questões ambientais relevantes no Brasil. Para dados em tempo real ou informações mais detalhadas, consulte diretamente as fontes mencionadas.
          </p>
        </CardContent>
      </Card>
    </div>
